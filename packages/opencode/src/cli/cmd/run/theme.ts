...
type ThemeJson = {
  ...
  theme: Omit<Record<ThemeColor, ColorValue>, "selectedListItemText" | "backgroundMenu" | "toolOutputText"> & {
...
export function resolveTheme(theme: ThemeJson, pick: "dark" | "light"): TuiThemeCurrent {
  ...
  return {
    ...
    toolOutputText:
      theme.theme.toolOutputText === undefined ? resolved.text! : resolveColor(theme.theme.toolOutputText),
